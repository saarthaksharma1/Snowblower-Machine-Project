...
public:
    ...
    */
    ...
    /**
     *shows the machine 1 dialog box
     * @param window The window to show the dialog box in
     */

    void ShowMachine1DialogBox(wxWindow *window);
    /**
     *shows the machine 2 dialog box
     * @param window The window to show the dialog box in
     */
    void ShowMachine2DialogBox(wxWindow *window);
     ...
     */
    void SetMachine1(std::shared_ptr<MachineDrawable> machine) {mMachine1 = machine;}
    /**
     * Sets the machine 2
     * @param machine The machine to set
     */
    void SetMachine2(std::shared_ptr<MachineDrawable> machine) {mMachine2 = machine;}
