...
ViewEdit::ViewEdit(wxFrame* parent) :wxScrolledCanvas(parent, wxID_ANY)
{
    ...
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewEdit::OnEditMachine1Properties, this, XRCID("EditMachine1Properties"));
    parent->Bind(wxEVT_COMMAND_MENU_SELECTED, &ViewEdit::OnEditMachine2Properties, this, XRCID("EditMachine2Properties"));
...
/**
 * Update the user interface for Edit>Machine1Properties
 * @param event
 */
void ViewEdit::OnEditMachine1Properties(wxCommandEvent& event)
{
    auto picture = GetPicture();
    picture->ShowMachine1DialogBox(this->GetParent());
    GetPicture()->UpdateObservers();
}
/**
 * Update the user interface for Edit>Machine2Properties
 * @param event
 */
void ViewEdit::OnEditMachine2Properties(wxCommandEvent& event)
{
    auto picture = GetPicture();
    picture->ShowMachine2DialogBox(this->GetParent());
    GetPicture()->UpdateObservers();
}
