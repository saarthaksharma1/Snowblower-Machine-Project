...
//    const int BackgroundHeight = 350;
    ...
    // The snow blower
    //
    auto blower =  std::make_shared<SnowBlower>(mImagesDir + L"/blowerL.png");
 ...
 * \return Shape object
 */
std::shared_ptr<Shape> MachineFactory1::CreatePost(int x, int y, int wid, int hit, wxColor color)
{
