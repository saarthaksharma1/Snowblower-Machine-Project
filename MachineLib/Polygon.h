 ...
 * 1.06 Changed how rotation works in some functions
 */
...
class Polygon {
    ...
    public:
        ...
        /**
         * Set the polygon rotation around its origin in turns.
         * @param rotation Rotation in turns
         */
        virtual void SetRotation(double rotation) { mRotation = rotation; }

        /**
         * Get the current polygon rotation around its origin.
         * @return Rotation in turns
         */
        double GetRotation() { return mRotation; }

        /**
         * Set an additive value that is added to the rotation for this polygon
         * This is useful for rotation offsets of a polygon.
         * @param phase Phase added in turns
         */
        void SetPhase(double phase) { mPhase = phase; }

        /**
         * Get the additive phase value
         * @return Phase value in turns
         */
